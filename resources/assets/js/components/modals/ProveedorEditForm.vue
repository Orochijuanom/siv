            ...
            <div class="modal-body">
                <form v-on:submit.prevent="createProveedor" method="post">
                        ...
                        <div class="card">
                            <div class="card-block">                                            
                                ...
                                <div style="border: 1px solid #e3e3e3; position: relative; z-index: 2; text-align: left; width: 100%;">
                                    <div onMouseOver="this.style.backgroundColor='rgba(225, 225, 225, 0.5)'" onMouseOut="this.style.backgroundColor='white'" style="padding: 20px 10px; background: white; border-bottom: 1px solid #e3e3e3" v-for="producto in apiNegocio.productos" v-on:click="setProducto(producto)">
                    ...
                    <div class="col-md-12">
                        ...
                        <br/>
                        <span class="tag" v-for="(producto, index) in data.productos">

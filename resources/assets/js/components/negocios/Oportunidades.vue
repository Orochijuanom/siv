...
<script>
    ...
    export default { 
        ...
        data () { 
            return {
                errors: [],  
                url: "http://localhost:8000/oportunidades/negocio/"+this.negocio,
                iframe: "<iframe src='http://localhost:8000/oportunidades/negocio/"+ this.negocio +"' width=100% height=100%>Texto para cuando el navegador no conoce la etiqueta iframe</iframe>",
                data: { 
                    nombre: '', 
                    email: '', 
                    negocio: '1', 
